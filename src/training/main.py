...
# Load data
df = pd.read_csv("processed_train_data_activity_anonymized.csv")
...
num_classes = 6 # number of classes act
...
best_hyperparameters = "./src/anonymization/hyperparams/best_hyperparameters_activity.json"
...
with open("log_time_training_act_anon.txt", "w") as f:
...
# Save model
model.save("HAR_anon.h5")

# Send email
send_email("training HAR anonymized model")
